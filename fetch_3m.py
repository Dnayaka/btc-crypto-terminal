#!/usr/bin/env python3
"""Fetch full 3m BTCUSDT.P history -> btc_3m_full.csv (paginasi startTime, resume-safe)."""
import os, sys, time, csv
import bot_v20_funding as B
HERE=os.path.dirname(os.path.abspath(__file__)); OUT=os.path.join(HERE,"btc_3m_full.csv")
START=1567962300000   # 2019-09-08 17:45 UTC (samain 15m/5m)
BARMS=3*60*1000
rows=[]
...
while t<now:
    try:
        kl=B.bget(f"/fapi/v1/klines?symbol=BTCUSDT&interval=3m&startTime={t}&limit=1500")
